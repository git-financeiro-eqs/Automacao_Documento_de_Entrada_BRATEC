...
class TratadorItem:
    ...
    def tratar_item(self):
        if self.ctrl_imposto == "Nenhum imposto":
        ...
        elif self.ctrl_imposto == "Apenas o ICMS":
        ...
        elif self.ctrl_imposto == "Apenas o ICMSST":
        ...
        elif self.ctrl_imposto == "Apenas o IPI":
        ...
        elif self.ctrl_imposto == "Apenas ICMSST e IPI":
        ...
        elif self.ctrl_imposto == "Apenas ICMS e IPI":
        ...
        elif self.ctrl_imposto == "Apenas ICMS e ICMSST":
        ...
        elif self.ctrl_imposto == "Todos os impostos":
