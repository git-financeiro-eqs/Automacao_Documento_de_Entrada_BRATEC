...
def contar_item_fracionado(quantidade_siga, valor_unit, quantidade_real):
    """
            ...
            if quantidade_siga == quantidade_NF:
                ...
                if "abracadeira" in desc_prod:
                    ...
                    if quantidade_convertida == quantidade_siga:
                        ...
                        razoes, cancelar_lancamento = contar_item_fracionado(quantidade_siga, valor_unit_convertido, quantidade_convertida)
                    ...
                    if cod_do_item == "0651000053":
                        razoes, cancelar_lancamento = contar_item_fracionado(quantidade_siga, valor_unit_NF, quantidade_NF)
                    else:
...
def definir_TES(codigo, ctrl_imposto):
    ...
    # As TES para lançamento da Bratec também são diferentes das da Matriz
...
def escrever_TES(tes, natureza):

    # Trecho diferente do Bot da matriz
    # Para o Caso da Bratec, por algum motivo, quando a TES é digitada se faz necessário
    # digitar novamente a natureza do item em seu campo próprio, pois ela some.
    # Isso impacta também no chamamento da função, que para a Bratec, é necessário passar a natureza como parâmetro.
